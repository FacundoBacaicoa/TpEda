...
public class Interfaz extends javax.swing.JFrame {
    ...
    public Interfaz() {
        ...
        txt_usuario.setText("{3*(7-6)-{3*7}-[6-3]}");
    }
    ...
    private void initComponents() {
        ...
        txt_usuario.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 12)); // NOI18N

        jBut.setText("Validar");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(jBut, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void jButActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButActionPerformed
        if (ValidarExpresion()) {
            JOptionPane.showMessageDialog(null, "La formula es Correcta");
        } else {
             JOptionPane.showMessageDialog(null, "La formula es Incorrecta");
        }
    ...
    public boolean ValidarExpresion() {
        Pila pila1 = new Pila();
        String cadena = txt_usuario.getText();
